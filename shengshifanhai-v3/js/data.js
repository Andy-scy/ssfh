...
window.SSFH_DATA = {
  ...
  /* ---------- 合作客户 ---------- */
  clients: [
    { name: '国家开发银行', work: '装修改造、空调设备升级改造' },
    { name: '人保财险北京分公司', work: '装修改造、防水维修' },
    { name: '航天工程大学', work: '装饰装修' },
    { name: '中国地震局', work: '防水维修、排风设备改造' },
    { name: '国家核电大厦', work: '装修改造、油烟设备升级改造' },
    { name: '中科院北京生物基因研究所', work: '室内装修升级改造' },
    { name: '北京市规自委通州分局', work: '装修改造' },
    { name: '北京市东城区审计局', work: '防水维修' },
    { name: '北京财富金融中心', work: '装修改造、防水维修' },
    { name: '北京财富购物中心', work: '室内外修缮工程' },
    { name: '远洋国际二期及未来汇购物中心', work: '室内装修、修缮、拆除' },
    { name: '阿玛尼公寓', work: '室外儿童游乐园设计施工' },
    { name: '北京金泽大厦', work: '防水维修' },
    { name: '知行车谷', work: '室内外装修升级改造' },
    ...
    { name: '中国机床产业园区', work: '彩钢顶防水维修' },
    { name: '造作（家居连锁）', work: '装饰装修' },
    { name: '悦动康乒乓球俱乐部（连锁）', work: '装饰装修' }
  ]
};
